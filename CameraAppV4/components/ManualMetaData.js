...
import AdjustableValues from './AdjustableValues';
    ...
    <View
      ...
      <View style={{ flex: 2, backgroundColor: 'black'}}>
        <View
          ...
          <View style={{ flex: 1 }}>
            <AdjustableValues name= 'Scene Type' />
          </View>
        </View>
        <View
          style={styles.dataRow}>
          <View style={{ flex: 1 }}>
            <AdjustableValues name= 'ISO' />
          </View>
          <View style={{ flex: 1 }}>
            <ExpandableValues name= 'Temperature' />
          </View>
          <View style={{ flex: 1 }}>
            <AdjustableValues name= 'White Balance' />
          </View>
        </View>
        <View
          style={styles.dataRow}>
          <View style={{ flex: 1 }}>
            <AdjustableValues name= 'Exposure' />
          </View>
          <View style={{ flex: 1 }}>
            <ExpandableValues name= 'Date' />
          </View>
          <View style={{ flex: 1 }}>
            <AdjustableValues name= 'Resolution' />
          </View>
        </View>
        <View
          style={styles.dataRow}>
          <View style={{ flex: 1 }}>
            <AdjustableValues name= 'Shutter Speed' />
          </View>
          <View style={{ flex: 1 }}>
